...
class UserProfileLikesAdapter @Inject constructor() :
    PagingDataAdapter<Recipe, UserProfileLikesAdapter.ViewHolder>(
        recipeComparator
    ) {

    override fun onBindViewHolder(holder: UserProfileLikesAdapter.ViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): UserProfileLikesAdapter.ViewHolder {
        val binding =
